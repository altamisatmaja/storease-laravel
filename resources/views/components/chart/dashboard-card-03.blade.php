        ...
        <header class="flex justify-between items-start mb-2">
            ...
            <div class="relative inline-flex" x-data="{ open: false }">
                <button class="rounded-full"
                    :class="open ? 'bg-gray-100  text-gray-500 ' :
                ...
                <div class="origin-top-right z-10 absolute top-full right-0 min-w-36 bg-white  border border-gray-200  py-1.5 rounded-lg shadow-lg overflow-hidden mt-1"
                    ...
                    <ul>
                        ...
                        <li>
                            <a class="font-medium text-sm text-red-500 hover:text-red-600 flex py-1 px-3" href="#0"
