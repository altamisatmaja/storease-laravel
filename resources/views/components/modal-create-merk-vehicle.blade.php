<!-- Search button -->
<div x-data="{ formMerkOpen: false }" class="relative">
    <!-- Button -->
    <button
        ...
        @click.prevent="formMerkOpen = true"
        aria-controls="modal-create-merk-vehicle">
    ...
    <!-- Modal backdrop -->
    <div class="fixed inset-0 bg-gray-900 bg-opacity-30 z-40 transition-opacity" x-show="formMerkOpen"
    ...
    <!-- Modal dialog -->
    <div id="modal-create-merk-vehicle"
        class="fixed inset-0 z-50 overflow-hidden flex items-center top-20 mb-4 justify-center px-4 sm:px-6"
        role="dialog" aria-modal="true" x-show="formMerkOpen" x-transition:enter="transition ease-in-out duration-200"
        ...
        <div class="bg-white border border-transparent overflow-auto max-w-2xl w-full max-h-full rounded-lg shadow-lg"
            @click.outside="formMerkOpen = false" @keydown.escape.window="formMerkOpen = false">
            <!-- Search form -->
            <form class="border-b border-gray-200">
                <div class="relative">
                    <div class="bg-white p-4 rounded-lg w-full">
                        <h1 class="text-xl font-semibold mb-4">Tambah merk</h1>
                        ...
                        <div class="grid grid-cols-2 gap-x-3 w-full">
                            <button type="submit" @click.prevent="formMerkOpen = false"
