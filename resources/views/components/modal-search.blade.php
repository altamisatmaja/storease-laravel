...
<div x-data="{ searchOpen: false }" class="z-50">
    ...
    >
        ...
        <svg class="fill-current text-gray-100" width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
        ...
        >
            ...
            <div class="py-4 px-2">
                ...
                <div class="mb-3 last:mb-0">
                    ...
                    <ul class="text-sm">
                        <li>
                            <a class="flex items-center p-2 text-gray-800  hover:bg-gray-100  rounded-lg" href="#0" @click="searchOpen = false" @focus="searchOpen = true" @focusout="searchOpen = false">
                                <svg class="fill-current text-gray-400  shrink-0 mr-3" width="16" height="16" viewBox="0 0 16 16">
                    ...
                    <ul class="text-sm">
                        <li>
                            <a class="flex items-center p-2 text-gray-800  hover:bg-gray-100  rounded-lg" href="#0" @click="searchOpen = false" @focus="searchOpen = true" @focusout="searchOpen = false">
                                ...
                                <span><span class="font-medium">Messages</span> - <span class="text-gray-600 ">Conversation / … / Mike Mills</span></span>
                            </a>
                        </li>
                        <li>
                            <a class="flex items-center p-2 text-gray-800  hover:bg-gray-100  rounded-lg" href="#0" @click="searchOpen = false" @focus="searchOpen = true" @focusout="searchOpen = false">
                                ...
                                <span><span class="font-medium">Messages</span> - <span class="text-gray-600 ">Conversation / … / Eva Patrick</span></span>
                            </a>
                        </li>
                    </ul>
                </div>
