...
@section('content')
    <div>
        ...
        <div class="grid md:grid-cols-2 gap-x-3 grid-cols-1">
            ...
            <div class="">
                <label class="block text-gray-800 text-xl font-bold mb-2">Hero Contact Us Page</label>
                <form action="{{ route('admin.dashboard.hero.contactus.update') }}" method="POST"
        ...
        <div class="my-4">
            <label class="block text-gray-800 text-xl font-bold mb-2">Hero Partner Page</label>
                    ...
                    <div class="my-4">
                        ...
                        <label
                            ...
                            <div class="h-full w-full text-center flex flex-col items-center justify-center">
                                <div class="relative w-full h-full flex items-center justify-center">
                                    <img id="image-preview" class=" w-96 h-full object-cover rounded-lg"
                                        src="{{ $heroPartner['image'] ? asset('uploads/' . $heroPartner['image']) : 'https://img.freepik.com/free-vector/image-upload-concept-landing-page_52683-27130.jpg?size=338&ext=jpg' }}"
                                        alt="Preview Image">
                                    <div
                                        class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity bg-black bg-opacity-50 rounded-lg">
                                        <svg class="w-12 h-12 text-white" xmlns="http://www.w3.org/2000/svg"
