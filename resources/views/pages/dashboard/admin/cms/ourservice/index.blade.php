                                    ...
                                    @foreach ($ourservices as $ourservice)
                                        <tr>
                                            ...
                                            <td class="px-4 py-4 text-sm text-gray-500  whitespace-nowrap">
                                                {{ $ourservice->vendor_name }}</td>
                                            <td class="px-4 py-4 text-sm text-gray-500  whitespace-nowrap">
                                                <div class="flex items-center gap-x-2">
                                                    <img class="object-cover w-8 h-8 rounded-lg"
                                                        src="{{ asset('uploads/' . $ourservice->vendor_image) }}"
                                                        alt="">
                                                </div>
                                            </td>
                                            <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                <div class="flex items-center gap-x-6">
                                                    <a
                                                        href="{{ route('admin.dashboard.cms.ourservice.edit', $ourservice->id) }}">
                                                        <button
                                                    ...
                                                    <form
                                                        action="{{ route('admin.dashboard.cms.ourservice.destroy', $ourservice->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
