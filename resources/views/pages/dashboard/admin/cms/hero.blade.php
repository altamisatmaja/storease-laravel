    ...
    <div>
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-gray-800 font-bold">Kelola hero section</h1>
            </div>
        ...
        <div class="grid md:grid-cols-2 gap-x-3 grid-cols-1">
            <div class="">
                <form action="{{ route('admin.dashboard.hero.home.title.change') }}" method="POST">
                    @csrf
                    <label for="title" class="block text-gray-800 text-xl font-bold mb-2">Hero Home Page</label>
                    <div class="my-2">
                        <label for="title" class="block text-gray-800 text-lg font-semibold mb-2">Judul hero</label>
                        <input type="text" name="title" id="title" required placeholder="{{ $hero[0]['title'] }}"
                ...
                <form action="{{ route('admin.dashboard.hero.home.image.change') }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="my-4">
                        <label for="image" class="block text-gray-800 text-lg font-semibold mb-2">Background
                            website</label>
                        <label
                        ...
                        <p class="mt-2">*Ini akan digunakan untuk <span class="font-bold">background</span> website!
                        </p>
            ...
            <div class="">
                <label for="title" class="block text-gray-800 text-xl font-bold mb-2">Hero Contact Us Page</label>
                <form action="">
                    <div class="my-2">
                        <label for="title" class="block text-gray-800 text-lg font-semibold mb-2">Judul hero</label>
                        <input type="text" name="title" id="title" required placeholder="{{ $hero[1]['title'] }}"
                            class="w-full text-md px-4 py-3 border-2 border-gray-200 rounded-lg text-gray-700 focus:ring-orange-600">
                        <p class="mt-2">*Ini akan digunakan untuk <span class="font-bold">title</span> hero!</p>
                    </div>
                    <button
                ...
                <form action="">
                    <div class="my-4">
                        <label for="title" class="block text-gray-800 text-lg font-semibold mb-2">Background
                            website</label>
                        <label
                            class="flex flex-col rounded-lg border-4 border-dashed w-full h-60 p-10 group text-center cursor-pointer">
                            <div class="h-full w-full text-center flex flex-col items-center justify-center">
