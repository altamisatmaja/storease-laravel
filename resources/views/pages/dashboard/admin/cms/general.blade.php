    ...
    <div>
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-gray-800 font-bold">Kelola konten general</h1>
            </div>
        ...
        <!-- Cards -->
        <div class="">
            <form action="{{ route('admin.dashboard.general.title.change') }}" method="POST">
                @csrf
                <div class="my-2">
            ...
            <form action="">
                <div class="my-4">
                    <label for="icon" class="block text-gray-800 text-lg font-semibold mb-2">Icon website</label>
                    <label
                        ...
                        <input type="file" class="hidden" name="icon">
                    </label>
