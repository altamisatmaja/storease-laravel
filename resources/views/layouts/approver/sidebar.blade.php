<div x-data="{ sidebarOpen: false }" class="flex h-screen bg-white shadow-md">
        ...
        <div class="flex flex-col h-full">
            ...
            <div class="flex items-center justify-center gap-x-4 h-16 bg-gray-800">
                ...
                <div class="flex flex-col">
                    ...
                    <div class="text-sm font-semibold text-gray-100 ">Approver</div>
                </div>
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <div class="lg:hidden items-center flex py-4">
            <ul class="space-y-2 mx-auto">
                <li
                    class="flex py-2 rounded-lg mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))] hover:bg-orange-400 hover:text-white ">
                    <a href="{{ route('dashboard') }}" class="block hover:text-white mx-auto truncate transition">
                ...
                <li class="flex flex-col mx-auto mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))]"
                    ...
                    <div class="lg:hidden lg:sidebar-expanded:block 2xl:block mx-auto">
                        <ul class="mt-2 " :class="open ? '!block' : 'hidden'">
                            ...
                            <li class="last:mb-0">
                                <a class="block  text-gray-500  hover:text-gray-700  transition truncate"
                ...
                <li
                    class="pl-3 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))] hover:bg-orange-400 hover:text-white ">
                    <a class="block truncate transition" href="{{ route('admin.dashboard') }}">
                        <div class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" height="30px" viewBox="0 -960 960 960"
                                width="30px" fill="currentColor">
                                <path
                ...
                <div class="space-y-2 pt-2 border-t-2 border-gray-200">
                    ...
                    <li
                        class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))] hover:bg-orange-400 hover:text-white ">
                        <a class="block  truncate transition" href="{{ route('admin.dashboard') }}">
                            <div class="flex items-center">
